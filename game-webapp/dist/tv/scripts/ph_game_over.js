...
BasicGame.GameOver.prototype = {
  ...
  create: function () {
      ...
      var t = this.add.text(this.game.width / 2, this.game.height / 2, gameOver_label, style);
      var t2 = this.add.text(this.game.width / 2, this.game.height / 2 + 80, gameOver_label, style);
